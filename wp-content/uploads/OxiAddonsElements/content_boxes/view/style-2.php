...
function oxi_content_boxes_style_2_shortcode($styledata = FALSE, $listdata = FALSE, $user = 'user') {
    ...
    foreach ($listdata as $value) {
        ...
        echo '<div class="' . OxiAddonsItemRows($styledata, 307) . '  ' . OxiAddonsAdminDefine($user) . '">';
