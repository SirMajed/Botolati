            ...
            <div class="inner-body">
                <article class="top">
                    <div class="col left">
                        ...
                        <h4><p> <?php echo esc_html($settings->get('some_more')); ?> </p> </h4> 
                    </div>
								...
								<?php foreach ($statistics as $statistic): ?>
									<?php if (!empty($statistic['title'])): ?>
                                        <li>
                                            ...
                                            <span>
                                             <h4> <?php echo esc_html($statistic['title']); ?></h4> 
                                            </span>
                                        </li>
									<?php endif; ?>
								<?php endforeach; ?>
            ...
            <div class="about-staff">
                <div class="section-header center-column col-white">
                    <div class="section-title">
                        <h2><?php echo esc_html__('تعرف على اعضاء الادارة', 'pixiefreak'); ?></h2>
                    </div>
					...
					<?php if ($aboutStaffCategory->isNotEmpty()): ?>
                        <ul class="menu-list">
							<?php $i=0; foreach ($aboutStaffCategory as $category): $i++;?>
								...
								<?php echo reset($aboutStaffCategory) === $category ? ' class="active"' : ''; ?>>
                                    <a href="#stca<?php echo esc_attr($category->id); ?>" data-toggle="tab">    <h2> <?php echo esc_html($category->name); ?> </h2>   </a>  
							...
							<?php if (count($aboutStaffCategory) > 4): ?>
                                <li class="menu-item-has-children">
                                    <a href="javascript:;">
										<?php esc_html_e('المزيد', 'pixiefreak'); ?>
