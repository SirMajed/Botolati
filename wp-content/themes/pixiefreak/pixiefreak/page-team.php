            ...
            <div class="inner-body">
                <article class="top">
                    <div class="col left about">
                        ...
                        <div class="details">
                            ...
                            <h5>
                             <?php echo esc_html(date_i18n("d M  Y", strtotime($team->year_founded)));                      ?>    <?php echo esc_html__(': تأسس في', 'pixiefreak'); ?>
                            </h5>
                ...
                <article class="bottom">
                    <div class="col left textarea">
                        <div class="text-head">
                            <h4><?php echo esc_html__('نبذة عن المشارك', 'pixiefreak'); ?></h4>
            ...
            <div class="team-roster">
                <div class="section-header center-column col-white">
                    <div class="section-title">
                        ...
                        <p><?php echo esc_html($settings->get('roster_subtitle')); ?></p>
                    </div>

                    <?php if ($settings->get('cta.show')): ?>
                    <div class="actions">
                        <a href="<?php echo esc_url($settings->get('cta.link')); ?>" class="btn btn-default">
		                   <h3> <?php echo esc_html($settings->get('cta.text')); ?></h3>
                        </a>
                    </div>
                    <?php endif; ?>
                </div>
