...
<section class="matches">
    <div class="container">
        <div class="inner-page-header">
            <div class="headline">
                <h4><?php echo esc_html__('حدد اختيارك من الفلتر', 'pixiefreak'); ?></h4>
              <span>  <h5><?php echo esc_html__('! وكن على معرفة بآخر نتائج البطولة', 'pixiefreak'); ?></h5></span>
            </div>

            <ul class="filter-list">
                <li>
                    <label class="checkbox-container" for="filter-all">
						<?php echo esc_html__('الكل', 'pixiefreak'); ?>
									...
									<?php if (count($tournament) > 0): ?>
                                        ...
                                        <span class="date">
                                            ...
                                            <a href="<?php echo pixiefreak_route('match', $match->slug); ?>">
                                                ...
                                                <?php echo esc_html__('Match Details', 'pixiefreak'); ?> 
