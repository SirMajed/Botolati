    ...
    <section class="match-page">
        <div class="container">
                            ...
                            <span class="date">
                                ...
                                <?php if (!empty($match->stream_id) && !empty($stream = \PixieFreakPanel\Model\Stream::query()->find($match->stream_id))): ?>
                                    <a href="<?php echo pixiefreak_route('stream', $stream->slug); ?>" target="_blank">
                                        <?php echo esc_html__('View stream', 'pixiefreak'); ?>
                    ...
                    <div class="match-details">
                        <div class="team-box">
                            ...
                            <div class="team-details">
                                <div class="team-name">
                                    <h2> <?php echo esc_html($ATeam->name); ?></h2>
                                </div>
                        ...
                        <div class="team-box">
                            ...
                            <div class="team-details">
                                 <div class="team-name">
                                    <h2> <?php echo esc_html($BTeam->name); ?></h2>
                                </div>
                        ...
                        <?php if (!empty($match->cta_match_text)): ?>
                            <li>
                                <a href="<?php echo esc_url($match->cta_match_link); ?>" target="_blank">
                                    <h6> <?php echo esc_html($match->cta_match_text); ?> </h6>
            ...
            <div class="inner-page-header">
                <div class="headline">
                    <h4><?php echo esc_html__('تابع المباريات بين الخصمين', 'pixiefreak'); ?></h4>
					
					  
					 <span> <h5> <?php echo esc_html__('حدد على اسم المشارك وشوف مواجهاتة', 'pixiefreak'); ?> </h5>  </span> 
                                    ...
                                    <div class="match-details">
                                        ...
                                        <div class="team-box">
                                            ...
                                            <div class="team-details">
                                                ...
                                                <div class="team-name">
                                                    <h3><?php echo esc_html($teamA->name); ?></h3>
                                                </div>
			                            ...
			                            <?php if (!empty($teamB)): ?>
                                            <div class="team-box">
                                                ...
                                                <div>
                                                    <div class="team-name">
                                                    <h3><?php echo esc_html($teamB->name); ?></h3>
                                                    </div>
