...
function gamipress_ultimate_member_user_profile_tabs( $tabs ) {
    ...
    if( in_array( $points_placement, array( 'tab', 'both' ) ) ) {
        ...
        $points_tab_title = gamipress_ultimate_member_get_option( 'points_tab_title', __( 'Achievements', 'gamipress-ultimate-member-integration' ) );
    ...
    if( in_array( $achievements_placement, array( 'tab', 'both' ) ) ) {
        ...
        $achievements_tab_title = gamipress_ultimate_member_get_option( 'achievements_tab_title', __( 'Achievements', 'gamipress-ultimate-member-integration' ) );
    ...
    if( in_array( $ranks_placement, array( 'tab', 'both' ) ) ) {
        ...
        $ranks_tab_title = gamipress_ultimate_member_get_option( 'ranks_tab_title', __( 'Ranks', 'gamipress-ultimate-member-integration' ) );
