 ...
 */
function OxiAddonsADMHelpItemPerRows($id = null, $styledata = null, $value = null, $control = null, $export = null, $dependentclass = '') {
    if ($control == 'true') {
    ...
    ?>
<div class="form-group row <?php echo $controldata;    echo $dependentclass;?>" >
 ...
 */
function oxi_addons_adm_help_date_picker($id = null, $value = null, $styledata = null, $control = null, $export = null, $exname = null, $dependentclass = '') {
    if ($control == 'true') {
        $controldata = 'oxi-addons-admin-lite-version ';
    } else {
        $controldata = ' ';
 ...
 */
function oxi_addons_adm_help_number($id = null, $value = null, $step = null, $name = null, $title = null, $control = null, $export = null, $exname = null, $numbertype = 'px', $lowestvalue = - 10000, $highestvalue = 10000, $dependentclass = '') {
    if ($control == 'true') {
        $controldata = 'oxi-addons-admin-lite-version ';
    } else {
        $controldata = ' ';
 ...
 */
function oxi_addons_adm_help_number_double_dtm($id = null, $laptop = null, $tab = null, $mobile = null, $id2 = null, $laptop2 = null, $tab2 = null, $mobile2 = null, $step = null, $name = null, $title = null, $control = 'true', $export = null, $exname = null, $numbertype = 'px', $dependentclass = '') {
    if ($control == 'true') {
        $controldata = 'oxi-addons-admin-lite-version ';
    } else {
        $controldata = ' ';
...
function OxiAddonsADMhelpBoxShadow($id = null, $fristnumber = null, $styledata = null, $control = 'true', $export = null) {
    ...
    if (strpos($styledata[$fristnumber], ":") !== FALSE) {
        $colorinset = explode(':', $styledata[$fristnumber]);
    } else {
        $colorinset = array($styledata[$fristnumber], '');
    }
    echo oxi_addons_adm_help_true_false($id . '-type', $colorinset[1], 'Normal', '', 'Inset', 'Inset', 'Shadow Type', 'Select your Box Shadow Type as Normal or Inset', 'true');
    echo '<div class="form-group row">
                <label for="' . $id . '-color" class="col-sm-6 control-label" oxi-addons-tooltip="Set your Box Shadow Color" >Box Shadow</label>
                <div class="col-sm-6 addons-dtm-laptop-lock">
                    <input type="text" data-format="rgb" data-opacity="true" class="form-control oxi-addons-minicolor oxi-addons-CF-data" id="' . $id . '-color" name="' . $id . '-color" value="' . $colorinset[0] . '">
                </div>
        </div>  
 ...
 */
function oxi_addons_adm_help_true_false($id = null, $value = null, $fristname = null, $fristvalue = null, $Secondname = null, $Secondvalue = null, $name = null, $title = null, $control = null, $dependentclass = '') {
    if ($control == 'true') {
        $controldata = 'oxi-addons-admin-lite-version';
    } else {
        $controldata = '';
    ...
    ?>
    <div class=" form-group row <?php echo $controldata; ?> <?php echo $dependentclass; ?>">
 ...
 */
function oxi_addons_adm_help_Heading_Tag($id = null, $value = null, $name = null, $title = null, $control = null, $dependentclass = '') {
    if ($control == 'true') {
        $controldata = 'oxi-addons-admin-lite-version';
    } else {
        $controldata = '';
 ...
 */
function oxi_addons_adm_help_Animation($id = null, $numberid = null, $styledata = null, $control = true, $export = null, $dependentclass = '') {
    ...
    ?>
    <div class="form-group row  <?php echo $dependentclass; ?>">
 ...
 */
function OxiAddonsTransformProperty($id = null, $value = null, $name = null, $title = null, $control = null, $export = null, $dependentclass = '') {
    ?>
    <div class="form-group row  <?php echo $dependentclass; ?>">
        <label for="<?php echo $id; ?>" class="col-sm-6 control-label"  oxi-addons-tooltip="<?php echo $title; ?>"><?php echo $name; ?> </label>
        <div class="col-sm-6 addons-dtm-laptop-lock">
 ...
 */
function oxi_addons_adm_help_border($id = null, $size = null, $type = null, $name = null, $title = null, $control = 'true', $export = null, $dependentclass = '') {
    if ($control == 'true') {
        $controldata = 'oxi-addons-admin-lite-version';
    } else {
        $controldata = '';
...
function oxi_addons_adm_help_select($id = null, $val = null, $name = null, $title = null, $arraydata = null, $dependentclass = '' ) {
    ?>
    <div class=" form-group row oxi-post-related-data  <?php echo $dependentclass; ?>">
...
function oxi_addons_adm_help_multiple_selection_style_1($id = null, $value = null, $name = null, $title = null, $arraydata = null, $dependentclass = '') {
  ...
  //  echo $value;
    ...
    <div class=" form-group row oxi-post-related-data <?php echo $dependentclass; ?>">
        <label for="<?php echo $id; ?>" class="col-sm-6 col-form-label" oxi-addons-tooltip="<?php echo $title; ?>"><?php echo $name; ?></label>
        <div class="col-sm-6 addons-dtm-laptop-lock">
            <select class="oxi-addons-multiple-select" multiple  id="<?php echo $id; ?>[]" name="<?php echo $id; ?>[]">
                <?php
                foreach ($arraydata as $key => $post_type) {
                    $seltd = '';
                    foreach ($valus as $val) {
                        $seltd .= selected($key, $val);
                    }
                    echo '<option value="' . $key . '" ' . $seltd . '>' . $post_type . '</option>';
                }
                ?>
            </select>
        </div>
 ...
 */
function oxi_addons_adm_help_textbox($id = null, $value = null, $name = null, $title = null, $control = null, $export = null, $dependentclass = '') {
...
function oxi_addons_adm_help_modal_textbox($id = null, $value = null, $name = null, $title = null, $dependentclass = '') {
    echo '  <div class="form-group '.$dependentclass.'">
...
function oxi_addons_adm_help_modal_textarea($id = null, $value = null, $name = null, $title = null, $dependentclass = '') {
    echo '  <div class="form-group '.$dependentclass.'">
                    <label for="' . $id . '">' . $name . '</label>
 ...
 */
function oxi_addons_adm_help_body_image_upload($id = null, $value = null, $name = null, $title = null, $control = null, $dependentclass = '') {
 ...
 */
function oxi_addons_adm_help_model_image_upload($id = null, $value = null, $name = null, $title = null, $control = null, $dependentclass ='') {
...
function oxi_addons_adm_help_modal_second_image_upload($id = null, $value = null, $name = null, $title = null, $dependentclass = '') {
    echo '  <div class="form-group row '.$dependentclass.'">
 ...
 */
function oxi_addons_adm_help_image_upload($id = null, $value = null, $name = null, $title = null, $control = null, $dependentclass = '') {
 ...
 */
function oxi_addons_adm_help_textarea($id = null, $value = null, $control = null, $export = null, $dependentclass = '') {
 ...
 */
function oxi_addons_adm_help_form_textarea($id = null, $value = null, $name = null, $title = null, $control = null, $export = null, $dependentclass = '') {
    if ($control == 'true') {
        $controldata = 'oxi-addons-admin-lite-version ';
    } else {
        $controldata = ' ';
    }
    echo '<div class="form-group ' . $controldata . ' '.$dependentclass.'"  oxi-addons-tooltip="' . $title . '" >
               <label for="' . $id . '">' . $name . '</label>
...
function OxiAddonsADMBoxShadowSanitize($id) {
    $data = $id . ' |' . sanitize_text_field($_POST[$id . '-color']) . ':' . sanitize_text_field($_POST[$id . '-type']) . '|' . sanitize_text_field($_POST[$id . '-horizontal']) . '|' . sanitize_text_field($_POST[$id . '-vertical']) . '|' . sanitize_text_field($_POST[$id . '-blur']) . '|' . sanitize_text_field($_POST[$id . '-spread']) . '|';
    return $data;
}
...
function oxi_addons_adm_help_multipledatasenitize($id) {
    $data = '';
    if (isset($_POST[$id])) {
        $postau = array_map('esc_attr', $_POST[$id]);
        $count = count($postau);
        for ($i = 0; $i < $count; $i++) {
            if (!empty($postau[$i])) {
                $data .= $postau[$i] . '';
