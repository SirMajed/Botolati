...
//            exit;
//        }
        $prolink = ' <li class="fazil-class" ><a target="_blank" href="https://www.oxilab.org/downloads/short-code-addons/">Upgrade</a></li>';
    ...
    $bgimage = WP_PLUGIN_URL . '/shortcode-addons/image/sa-logo.png';
    echo '<div class="oxi-addons-wrapper">
                    <div class="oxilab-new-admin-menu">
                        <div class="oxi-site-logo">
                            <a href="' . admin_url('admin.php?page=oxi-addons') . '" class="header-logo" style=" background-image: url(' . $bgimage . ');">
                            </a>
                        </div>
    ...
    if ((isset($_GET['page']) && $_GET['page'] == 'oxi-addons')) {
        if ((isset($_GET['oxitype']))) {
            $oxitype = sanitize_text_field($_GET['oxitype']);
            echo '<li class="active"><a href="' . admin_url('admin.php?page=oxi-addons&oxitype=' . $oxitype) . '">' . oxi_addons_shortcode_name_converter($oxitype) . '</a></li>
                  <li><a href="' . admin_url('admin.php?page=oxi-addons-import-data') . '">Import Layouts</a></li>';
        } else {
            echo '<li class="active"><a href="' . admin_url('admin.php?page=oxi-addons') . '">Elements</a></li>
                  <li><a href="' . admin_url('admin.php?page=oxi-addons-import') . '">Import Elements</a></li>
                  <li><a href="' . admin_url('admin.php?page=oxi-addons-import-data') . '">Import Layouts</a></li>';
        }
    }if ((isset($_GET['page']) && $_GET['page'] == 'oxi-addons-el-template')) {
        $p = (empty($_GET['saetype']) ? TRUE : FALSE);
        echo ' <li class="' . ($p ? 'active' : '') . '"><a href="' . admin_url('admin.php?page=oxi-addons-el-template') . '">Templates</a></li>
               <li class="' . ($p ? '' : 'active') . '"><a href="' . admin_url('admin.php?page=oxi-addons-el-template&saetype=blocks') . '">Blocks</a></li>';
    } else if ((isset($_GET['page']) && ($_GET['page'] == 'oxi-addons-import' || $_GET['page'] == 'oxi-addons-import-data' || $_GET['page'] == 'oxi-addons-settings' || $_GET['page'] == 'oxi-addons-documentation'))) {
        echo '  <li><a href="' . admin_url('admin.php?page=oxi-addons') . '">Elements</a></li>
                <li><a href="' . admin_url('admin.php?page=oxi-addons-import') . '">Import Elements</a></li>
                <li><a href="' . admin_url('admin.php?page=oxi-addons-import-data') . '">Import Layouts</a></li>';
        if ($_GET['page'] == 'oxi-addons-import') {
            $js = 'jQuery(".oxilab-new-admin-menu .oxilab-sa-admin-menu li:eq(1)").addClass("active");';
        } else if ($_GET['page'] == 'oxi-addons-import-data') {
            $js = 'jQuery(".oxilab-new-admin-menu .oxilab-sa-admin-menu li:eq(2)").addClass("active");';
        } else if ($_GET['page'] == 'oxi-addons-documentation') {
            $js = 'jQuery(".oxilab-new-admin-menu .oxilab-sa-admin-menu2 .saadmin-doc").addClass("active");';
        } else {
            $js = 'jQuery(".oxilab-new-admin-menu .oxilab-sa-admin-menu2 .saadmin-set").addClass("active");';
        }
        echo '<script type="text/javascript">setTimeout(function () {' . $js . '}, 200);</script>';
    }
    ...
    echo '                  </ul>
                            <ul class="oxilab-sa-admin-menu2">
                                ...
                                <li class="saadmin-set"><a href="' . admin_url('admin.php?page=oxi-addons-settings') . '"><span class="dashicons dashicons-admin-generic"></span></a></li>
                            </ul>
                        </nav>
                    </div>
                </div>';
