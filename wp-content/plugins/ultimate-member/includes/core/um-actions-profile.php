	...
	if ( $args['cover_enabled'] == 1 ) {
		...
		$overlay = '<span class="um-cover-overlay">
				<span class="um-cover-overlay-s">
					<ins>
						...
						<span class="um-cover-overlay-t">' . __( 'تغيير خلفية الحساب', 'ultimate-member' ) . '</span>
					</ins>
				</span>
			</span>';
		...
		<div class="um-cover <?php if ( um_user( 'cover_photo' ) || ( $default_cover && $default_cover['url'] ) ) echo 'has-cover'; ?>"
			...
			if ( UM()->fields()->editing ) {
				...
				$text = ! um_user( 'cover_photo' ) ? __( 'رفع خلفية جديدة', 'ultimate-member' ) : __( 'تغيير الخلفية', 'ultimate-member' ) ;

				$items = array(
					'<a href="javascript:void(0);" class="um-manual-trigger" data-parent=".um-cover" data-child=".um-btn-auto-width">' . $text . '</a>',
					'<a href="javascript:void(0);" class="um-reset-cover-photo" data-user_id="' . um_profile_id() . '" ' . $hide_remove . '>' . __( 'حذف', 'ultimate-member' ) . '</a>',
					'<a href="javascript:void(0);" class="um-dropdown-hide">' . __( 'الغاء', 'ultimate-member' ) . '</a>',
				);
				...
				if ( ! isset( UM()->user()->cannot_edit ) && ! um_user( 'cover_photo' ) ) {
					...
					$items = array(
						'<a href="javascript:void(0);" class="um-manual-trigger" data-parent=".um-cover" data-child=".um-btn-auto-width">' . __( 'رفع خلفية جديدة', 'ultimate-member' ) . '</a>',
						'<a href="javascript:void(0);" class="um-dropdown-hide">' . __( 'الغاء', 'ultimate-member' ) . '</a>',
					);
				...
				<?php if ( um_user( 'cover_photo' ) ) {
					...
					if ( ! isset( UM()->user()->cannot_edit ) ) { ?>
						...
						<a href="javascript:void(0);" class="um-cover-add"><span class="um-cover-add-i"><i
									...
									title="<?php _e( 'رفع خلفية جديدة', 'ultimate-member' ); ?>"></i></span></a>
		...
		<div class="um-profile-photo" data-user_id="<?php echo um_profile_id(); ?>">
			...
			<?php if ( empty( $disable_photo_uploader ) && empty( UM()->user()->cannot_edit ) ) {
				...
				if ( ! um_profile( 'profile_photo' ) ) { // has profile photo
					...
					$items = array(
						'<a href="javascript:void(0);" class="um-manual-trigger" data-parent=".um-profile-photo" data-child=".um-btn-auto-width">' . __( 'رفع صورة جديدة', 'ultimate-member' ) . '</a>',
						'<a href="javascript:void(0);" class="um-dropdown-hide">' . __( 'الغاء', 'ultimate-member' ) . '</a>',
					);
					...
					$items = array(
						'<a href="javascript:void(0);" class="um-manual-trigger" data-parent=".um-profile-photo" data-child=".um-btn-auto-width">' . __( 'تغيير الصورة', 'ultimate-member' ) . '</a>',
						'<a href="javascript:void(0);" class="um-reset-profile-photo" data-user_id="' . um_profile_id() . '" data-default_src="' . um_get_default_avatar_uri() . '">' . __( 'حذف الصورة', 'ultimate-member' ) . '</a>',
						'<a href="javascript:void(0);" class="um-dropdown-hide">' . __( 'الغاء', 'ultimate-member' ) . '</a>',
					);
			...
			<?php } else if (UM()->fields()->editing == true && $args['show_bio']) { ?>
				...
				<div class="um-meta-text">
					<textarea id="um-meta-bio"
							  ...
							  placeholder="<?php _e( '... اكتب نبذة عنك', 'ultimate-member' ); ?>"
...
function um_add_edit_icon( $args ) {
	...
	if ( ! um_is_myprofile() ) {
		...
		if ( UM()->roles()->um_current_user_can( 'edit', um_profile_id() ) ) {
			$items['editprofile'] = '<a href="' . um_edit_profile_url() . '" class="real_url">' . __( 'تعديل البروفايل', 'ultimate-member' ) . '</a>';
		}
		...
		*/
		...
		$items['cancel'] = '<a href="#" class="um-dropdown-hide">' . __( 'الغاء', 'ultimate-member' ) . '</a>';

	} else {
		$items = array(
			'editprofile' => '<a href="' . um_edit_profile_url() . '" class="real_url">' . __( 'تعديل البروفايل', 'ultimate-member' ) . '</a>',
			'myaccount'   => '<a href="' . um_get_core_page( 'account' ) . '" class="real_url">' . __( 'حسابي', 'ultimate-member' ) . '</a>',
			'logout'      => '<a href="' . um_get_core_page( 'logout' ) . '" class="real_url">' . __( 'تسجيل الخروج', 'ultimate-member' ) . '</a>',
			'cancel'      => '<a href="javascript:void(0);" class="um-dropdown-hide">' . __( 'الغاء', 'ultimate-member' ) . '</a>',
		);
