	...
	class Account {
		...
		function get_tabs() {
			...
			$tabs[100]['general'] = array(
				'icon'          => 'um-faicon-user',
				'title'         => __( 'الحساب', 'ultimate-member' ),
				'submit_title'  => __( 'تأكيد التغييرات', 'ultimate-member' ),
			);

			$tabs[200]['password'] = array(
				'icon'          => 'um-faicon-asterisk',
				'title'         => __( 'تغيير الرقم السري', 'ultimate-member' ),
				'submit_title'  => __( 'تأكيد الرقم السري', 'ultimate-member' ),
			);

			$tabs[300]['privacy'] = array(
				'icon'          => 'um-faicon-lock',
				'title'         => __( 'الخصوصية', 'ultimate-member' ),
				'submit_title'  => __( 'تغيير الخصوصية', 'ultimate-member' ),
			);

			$tabs[400]['notifications'] = array(
				'icon'          => 'um-faicon-envelope',
				'title'         => __( 'الاشعارات', 'ultimate-member' ),
				'submit_title'  => __( 'تعديل التغييرات', 'ultimate-member' ),
			);
			...
			if ( um_user( 'can_delete_profile' ) || um_user( 'can_delete_everyone' ) ) {
				...
				$tabs[99999]['delete'] = array(
					...
					'title'         => __( 'حذف الحساب', 'ultimate-member' ),
					'submit_title'  => __( 'حذف الحساب', 'ultimate-member' ),
				);
