				...
				<div class="um-field um-field-block um-field-type_block">
					<div class="um-field-block">
						<div style="text-align:center;">
							<?php _e( '. لقد ارسلنا رابط تغيير رقمك السري على البريد الالكتروني', 'ultimate-member' ); ?>
						</div>
					</div>
				</div>
			<?php } else { ?>
						...
						<div class="um-field-block">
							<div style="text-align:center;">
								<?php if ( 'expiredkey' == $_GET['updated'] ) {
									_e( 'تم انتهاء مدة الرابط , الرجاء طلب رابط جديد', 'ultimate-member' );
								} elseif ( 'invalidkey' == $_GET['updated'] ) {
									_e( 'يبدو ان الرابط غير صحيح , الرجاء المحاولة مرة اخرى', 'ultimate-member' );
								} ?>
							</div>
						</div>
					</div>
				<?php } else { ?>
					<div class="um-field um-field-block um-field-type_block">
						<div class="um-field-block">
							<div style="text-align:center;">
								<?php _e('لأستعادة كلمة مرورك الرجاء ادخل احد من البريد الالكتروني او اسم المستخدم','ultimate-member'); ?>
							</div>
						</div>
					</div>
				<?php }
				...
				<div class="um-col-alt um-col-alt-b">
					...
					<div class="um-center">
						<input type="submit" value="<?php esc_attr_e('استعاذة الرقم السري','ultimate-member' ); ?>" class="um-button" id="um-submit-btn" />
					</div>
