...
<div class="um-field um-field-type_terms_conditions" data-key="use_terms_conditions_agreement" style="display:block;padding:0;">
	<div class="um-field-area">
		...
		<?php $toggle_show = ! empty( $args['use_gdpr_toggle_show'] ) ? $args['use_gdpr_toggle_show'] : __( 'عرض قوانين بطولاتي', 'ultimate-member' );
		$toggle_hide = ! empty( $args['use_gdpr_toggle_hide'] ) ? $args['use_gdpr_toggle_hide'] : __( 'اخفاء قوانين بطولاتي', 'ultimate-member' );
		$toggle_title = ! empty( $args['use_gdpr_toggle_show'] ) ? $args['use_gdpr_toggle_show'] : __( 'عرض قوانين بطولاتي', 'ultimate-member' ); ?>
	...
	<div class="um-field-area">
		...
		<?php $confirm = ! empty( $args['use_gdpr_agreement'] ) ? $args['use_gdpr_agreement'] :  __( 'الرجاء تأكيد على قراءة قوانين بطولاتي', 'ultimate-member' ); ?>
		...
		if ( isset( $errors['use_gdpr_agreement'] ) ) {
			...
			$error_message = ! empty( $args['use_gdpr_error_text'] ) ? $args['use_gdpr_error_text'] :  __( 'الرجاء تأكيد على قراءة قوانين بطولاتي', 'ultimate-member' ); ?>
